...
def idris_Python_46__36__58_(e0, e1, e2, idris_args):
  while True:
    return (65675, None, None, None, e2, (65667, idris_args))
...
def idris_Python_46__47__58_(e0, e1, e2, e3, e4):
  while True:
    return (65675, None, None, None, e2, (65669, e3))
...
def idris_Python_46_collect(e0, e1):
  while True:
    return idris_Prelude_46_Functor_46_Prelude_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
             ...
             None,
             (65662, None, (0,)),
             idris_Python_46_foreach(None, None, e1, (0,), (65671,))
           )
...
def idris_Prelude_46_List_46_foldrImpl(e0, e1, e2, e3, e4, e5):
  while True:
    if e5[0] == 1: # Prelude.List.::
      in0, in1, = e5[1:]
      e0, e1, e2, e3, e4, e5, = None, None, e2, e3, (65659, None, None, None, e4, APPLY0(e2, in0)), in1,
      continue
...
def idris_Main_46_main():
  while True:
    return (65675, # {U_io_bind1}
             None,
             None,
             None,
             idris_Python_46_import_95_(None, (65637,)),
             (65650,)
           )
...
def idris_Prelude_46_putStr(e0, e1):
  while True:
    return (65675, None, None, None, (65663, e1), (65664,))
...
def idris_Prelude_46_Functor_46__123_Prelude_46_IO_39__32_ffi_32_instance_32_of_32_Prelude_46_Functor_46_Functor_44__32_method_32_map0_125_(e3, in0):
  while True:
    return (65676, None, None, APPLY0(e3, in0))

# Python.{collect0}
def idris_Python_46__123_collect0_125_(in0, in1):
  while True:
    return (65676, None, None, (1, in1, in0))
...
def idris_Prelude_46__123_putStr1_125_(in1):
  while True:
    return (65676, None, None, (0,))

# {io_bind2}
def io_bind2(e0, e1, e2, e3, e4, idris_w):
  while True:
    return (65677, e0, e1, e2, e3, e4, idris_w)

# Main.{main2}
def idris_Main_46__123_main2_125_(in14, in15, in16):
  while True:
    return idris_Prelude_46_List_46_foldrImpl(None, None, in14, in15, (65660, None), in16)

# Main.{main3}
def idris_Main_46__123_main3_125_(in14, in15):
  while True:
    return (65651, in14, in15)
...
def idris_Main_46__123_main9_125_(in11):
  while True:
    return idris_Prelude_46_Functor_46_Prelude_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
             ...
             None,
             None,
             idris_Prelude_46_Foldable_46_concat(None, None, (65655,), (0, (65657,), "")),
             in11
           )
  ...
  while True:
    return (65675, # {U_io_bind1}
             ...
             (65675, # {U_io_bind1}
               ...
               (65659, None, None, None, (65658,), (65665, None))
             ),
             (65639, in9)
           )
...
def idris_Main_46__123_main15_125_(in7, in8):
  while True:
    return (65675, # {U_io_bind1}
             ...
             None,
             None,
             idris_Python_46_foreach(None, None, in7, 0, (65641,)),
             (65642,)
           )
...
def idris_Main_46__123_main19_125_(in3):
  while True:
    return (65675, # {U_io_bind1}
             ...
             None,
             None,
             idris_Python_46_import_95_(None, (65648,)),
             (65646, in3)
           )
...
def idris_Prelude_46_Functor_46_Prelude_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(e0, e1, e2, e3, e4):
  while True:
    return (65675, None, None, None, e4, (65661, e3))
