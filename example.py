...
def APPLY0(fn0, arg0):
  while True:
    ...
    elif fn0[0] == 65648: # {U_Main.{main3}1}
    ...
    elif fn0[0] == 65651: # {U_Main.{main6}1}
    ...
    elif fn0[0] == 65654: # {U_Main.{main9}1}
      P_c0, = fn0[1:]
    ...
    elif fn0[0] == 65657: # {U_Prelude.List.List instance of Prelude.Foldable.Foldable1}
    ...
    elif fn0[0] == 65659: # {U_Prelude.{putStr0}1}
      P_c0, = fn0[1:]
    ...
    elif fn0[0] == 65668: # {U_Python.{foreach0}1}
    ...
    elif fn0[0] == 65670: # {U_believe_me1}
      P_c0, P_c1, = fn0[1:]
    ...
    elif fn0[0] == 65673: # {U_{io_bind1}1}
    ...
    elif fn0[0] == 65676: # {U_Prelude.List.List instance of Prelude.Foldable.Foldable4}
      P_c0, = fn0[1:]
...
def idris_Prelude_46_Functor_46__123_Prelude_46_IO_39__32_ffi_32_instance_32_of_32_Prelude_46_Functor_46_Functor_44__32_method_32_map_95_lam0_125_(e3, in0):
  while True:
