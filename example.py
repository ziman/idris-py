...
def _idris_Python_46_Functions_46__36__58_(e0, e1, e2, e3):
  while True:
    return (65791, None, None, None, e2, (65759, e1, e3))  # {U_io_bind1}, {U_Python.Functions.{$:0}1}
...
def _idris_Python_46_Fields_46__47__46_(e0, e1, e2, e3, e4):
  while True:
    return _idris_Prelude_46_Functor_46_Prelude_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
      ...
      None,
      None,
      (65761, None),  # {U_Python.IO.unRaw1}
      (65757, e2, e3)  # {U_Python.Fields.{/.0}1}
    )

# Python.Fields./:
def _idris_Python_46_Fields_46__47__58_(e0, e1, e2, e3, e4):
  while True:
    return (65791, None, None, None, e2, (65758, e3))  # {U_io_bind1}, {U_Python.Fields.{/:0}1}
...
def _idris_Python_46_Fields_46__62__58_(e0, e1, e2, e3):
  while True:
    return _idris_Prelude_46_Functor_46_Prelude_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
      ...
      None,
      None,
      (65756, None, None, None),  # {U_Python.Fields.mixout1}
      e1
    )
...
def _idris_Python_46_Functions_46_call(e0, e1, e2, e3, e4, e5):
  while True:
    return _idris_Prelude_46_Functor_46_Prelude_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
      ...
      None,
      (65761, None),  # {U_Python.IO.unRaw1}
      (65760, e3, e2, e5)  # {U_Python.Functions.{call0}1}
    )
...
def _idris_Python_46_Exceptions_46_catch(e0, e1, e2):
  while True:
    return (65791, None, None, None, e1, (65728, e2))  # {U_io_bind1}, {U_Python.Exceptions.{catch6}1}
...
def _idris_Python_46_Prim_46_collect(e0, e1):
  while True:
    return _idris_Prelude_46_Functor_46_Prelude_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
      ...
      _idris_Python_46_Prim_46_foreach(None, None, e1, ConsList(), (65772,))  # {U_Python.Prim.{collect1}1}
    )
...
def _idris_Python_46_Prim_46_foreach(e0, e1, e2, e3, e4):
  while True:
    return (
      ...
      (65774, e2, e3, e4)  # {U_Python.Prim.{foreach1}1}
    )
...
def _idris_Python_46_Lib_46_Threading_46_forkPIO(e0, e1):
  while True:
    return (
      ...
      _idris_Python_46_Functions_46__36__58_(
        None,
        (1, (1,), (65762,)),  # Python.Telescope.Dep, Python.Telescope.Forall, {U_Python.Lib.Threading.{forkPIO0}1}
      ...
      (65767, e1)  # {U_Python.Lib.Threading.{forkPIO5}1}
    )
...
def _idris_Python_46_Prim_46_iterate(e0, e1, e2, e3, e4):
  while True:
    return (
      ...
      (65775, e3, e4)  # {U_Python.Prim.{iterate0}1}
    )
...
def _idris_Prelude_46_Strings_46_length():
  while True:
    return (
      ...
      None,
      None,
      (65713, None, None, None, (65717,), (65793,)),  # {U_Prelude.Basics..1}, {U_Prelude.Strings.{length0}1}, {U_prim__zextInt_BigInt1}
      (65794,)  # {U_prim_lenString1}
    )
...
def _idris_Python_46_marshalPIO(e0, e1):
  while True:
    return _idris_unsafePerformIO(None, None, (65790, e1))  # {U_Python.{marshalPIO0}1}
...
def _idris_Prelude_46_putStr(e0, e1):
  while True:
    return (65791, None, None, None, (65718, e1), (65719,))  # {U_io_bind1}, {U_Prelude.{putStr0}1}, {U_Prelude.{putStr1}1}
...
def _idris_Python_46_Exceptions_46_try(e0, e1):
  while True:
    return (65791, None, None, None, (65750, e1), (65747,))  # {U_io_bind1}, {U_Python.Exceptions.{try4}1}, {U_Python.Exceptions.{try24}1}
...
def _idris_Python_46_Lib_46_Threading_46_wait(e0, e1):
  while True:
    return _idris_Python_46_Functions_46__36__58_(
      None,
      (1, (0,), (65768,)),  # Python.Telescope.Dep, Python.Telescope.Pi, {U_Python.Lib.Threading.{wait0}1}
        ...
        if fn0[0] < 65661:
          if fn0[0] < 65650:
            if fn0[0] < 65644:
              ...
              if fn0[0] < 65647:
                if fn0[0] == 65644:  # {U_Main.{main10}1}
                  return _idris_Main_46__123_main10_125_(arg0)
                elif fn0[0] == 65645:  # {U_Main.{main11}1}
                  P_c0 = fn0[1]
                ...
                if fn0[0] == 65647:  # {U_Main.{main13}1}
                  P_c0 = fn0[1]
                  return _idris_Main_46__123_main13_125_(P_c0, arg0)
                elif fn0[0] == 65648:  # {U_Main.{main14}1}
            ...
            if fn0[0] < 65655:
              if fn0[0] < 65652:
                ...
                if fn0[0] == 65652:  # {U_Main.{main18}1}
                  return _idris_Main_46__123_main18_125_(arg0)
                elif fn0[0] == 65653:  # {U_Main.{main19}1}
          ...
          if fn0[0] < 65672:
            if fn0[0] < 65666:
              if fn0[0] < 65663:
                if fn0[0] == 65661:  # {U_Main.{main26}1}
              ...
              if fn0[0] < 65669:
                if fn0[0] == 65666:  # {U_Main.{main30}1}
                  P_c0 = fn0[1]
                ...
                if fn0[0] == 65669:  # {U_Main.{main33}1}
                  return _idris_Main_46__123_main33_125_(arg0)
                elif fn0[0] == 65670:  # {U_Main.{main34}1}
            ...
            if fn0[0] < 65677:
              ...
              if fn0[0] < 65680:
                if fn0[0] == 65677:  # {U_Main.{main40}1}
                  P_c0 = fn0[1]
                  return _idris_Main_46__123_main40_125_(P_c0, arg0)
                elif fn0[0] == 65678:  # {U_Main.{main41}1}
                  P_c0 = fn0[1]
          ...
          if fn0[0] < 65694:
            if fn0[0] < 65688:
              ...
              if fn0[0] < 65691:
                ...
                if fn0[0] == 65691:  # {U_Main.{main53}1}
            ...
            if fn0[0] < 65699:
              if fn0[0] < 65696:
                if fn0[0] == 65694:  # {U_Main.{main56}1}
                  P_c0 = fn0[1]
                ...
                if fn0[0] == 65696:  # {U_Main.{main58}1}
                  P_c0 = fn0[1]
              ...
              if fn0[0] < 65702:
                if fn0[0] == 65699:  # {U_Main.{main60}1}
                  P_c0 = fn0[1]
                  return _idris_Main_46__123_main60_125_(P_c0, arg0)
                elif fn0[0] == 65700:  # {U_Main.{main61}1}
                  P_c0 = fn0[1]
                ...
                if fn0[0] == 65702:  # {U_Main.{main63}1}
                  P_c0, P_c1 = fn0[1:]
                  return _idris_Main_46__123_main63_125_(P_c0, P_c1, arg0)
                elif fn0[0] == 65703:  # {U_Main.{main64}1}
                  P_c0 = fn0[1]
          ...
          if fn0[0] < 65716:
            if fn0[0] < 65710:
              if fn0[0] < 65707:
                ...
                if fn0[0] == 65707:  # {U_Main.{main68}1}
                  return _idris_Main_46__123_main68_125_(arg0)
                elif fn0[0] == 65708:  # {U_Main.{main69}1}
            ...
            if fn0[0] < 65722:
              if fn0[0] < 65719:
                if fn0[0] == 65716:  # {U_Prelude.List.reverse, reverse'1}
                  P_c0, P_c1 = fn0[1:]
                ...
                if fn0[0] == 65719:  # {U_Prelude.{putStr1}1}
                  return _idris_Prelude_46__123_putStr1_125_(arg0)
                elif fn0[0] == 65720:  # {U_Python.Exceptions.{case block in case block in try_lam0}1}
                  P_c0, P_c1 = fn0[1:]
              ...
              if fn0[0] < 65725:
                if fn0[0] == 65722:  # {U_Python.Exceptions.{catch0}1}
                  return _idris_Python_46_Exceptions_46__123_catch0_125_(arg0)
                elif fn0[0] == 65723:  # {U_Python.Exceptions.{catch1}1}
      ...
      if fn0[0] < 65773:
        if fn0[0] < 65750:
          if fn0[0] < 65739:
            if fn0[0] < 65733:
              ...
              if fn0[0] < 65736:
                if fn0[0] == 65733:  # {U_Python.Exceptions.{try11}1}
                  return _idris_Python_46_Exceptions_46__123_try11_125_(arg0)
                elif fn0[0] == 65734:  # {U_Python.Exceptions.{try12}1}
                ...
                if fn0[0] == 65736:  # {U_Python.Exceptions.{try14}1}
                  return _idris_Python_46_Exceptions_46__123_try14_125_(arg0)
                elif fn0[0] == 65737:  # {U_Python.Exceptions.{try15}1}
            ...
            if fn0[0] < 65744:
              if fn0[0] < 65741:
                if fn0[0] == 65739:  # {U_Python.Exceptions.{try17}1}
                  P_c0 = fn0[1]
                ...
                if fn0[0] == 65741:  # {U_Python.Exceptions.{try19}1}
              ...
              if fn0[0] < 65747:
                if fn0[0] == 65744:  # {U_Python.Exceptions.{try21}1}
                ...
                if fn0[0] == 65747:  # {U_Python.Exceptions.{try24}1}
          ...
          if fn0[0] < 65761:
            if fn0[0] < 65755:
              if fn0[0] < 65752:
                if fn0[0] == 65750:  # {U_Python.Exceptions.{try4}1}
                  P_c0 = fn0[1]
              ...
              if fn0[0] < 65758:
                if fn0[0] == 65755:  # {U_Python.Exceptions.{try9}1}
                  return _idris_Python_46_Exceptions_46__123_try9_125_(arg0)
                elif fn0[0] == 65756:  # {U_Python.Fields.mixout1}
                  P_c0, P_c1, P_c2 = fn0[1:]
                ...
                if fn0[0] == 65758:  # {U_Python.Fields.{/:0}1}
                  P_c0 = fn0[1]
                  return _idris_Python_46_Fields_46__123__47__58_0_125_(P_c0, arg0)
                elif fn0[0] == 65759:  # {U_Python.Functions.{$:0}1}
                  P_c0, P_c1 = fn0[1:]
            ...
            if fn0[0] < 65767:
              if fn0[0] < 65764:
                if fn0[0] == 65761:  # {U_Python.IO.unRaw1}
                  P_c0 = fn0[1]
                  return _idris_Python_46_IO_46_unRaw(P_c0, arg0)
                elif fn0[0] == 65762:  # {U_Python.Lib.Threading.{forkPIO0}1}
                ...
                if fn0[0] == 65764:  # {U_Python.Lib.Threading.{forkPIO2}1}
                  return _idris_Python_46_Lib_46_Threading_46__123_forkPIO2_125_(arg0)
                elif fn0[0] == 65765:  # {U_Python.Lib.Threading.{forkPIO3}1}
                  P_c0 = fn0[1]
              ...
              if fn0[0] < 65770:
                if fn0[0] == 65767:  # {U_Python.Lib.Threading.{forkPIO5}1}
                  P_c0 = fn0[1]
                  return _idris_Python_46_Lib_46_Threading_46__123_forkPIO5_125_(P_c0, arg0)
                elif fn0[0] == 65768:  # {U_Python.Lib.Threading.{wait0}1}
                ...
                if fn0[0] == 65770:  # {U_Python.Prim.{case block in Python.Prim.iterate, iter_lam0}1}
                  P_c0, P_c1 = fn0[1:]
                  return _idris_Python_46_Prim_46__123_case_32_block_32_in_32_Python_46_Prim_46_iterate_44__32_iter_95_lam0_125_(
                    P_c0, P_c1, arg0
                  )
                elif fn0[0] == 65771:  # {U_Python.Prim.{collect0}1}
                  P_c0 = fn0[1]
        ...
        if fn0[0] < 65795:
          if fn0[0] < 65784:
            if fn0[0] < 65778:
              if fn0[0] < 65775:
                if fn0[0] == 65773:  # {U_Python.Prim.{foreach0}1}
                  P_c0, P_c1, P_c2 = fn0[1:]
                ...
                if fn0[0] == 65775:  # {U_Python.Prim.{iterate0}1}
                  P_c0, P_c1 = fn0[1:]
                  return _idris_Python_46_Prim_46__123_iterate0_125_(P_c0, P_c1, arg0)
                elif fn0[0] == 65776:  # {U_Python.Prim.{next0}1}
              ...
              if fn0[0] < 65781:
                if fn0[0] == 65778:  # {U_Python.Prim.{next11}1}
                  return _idris_Python_46_Prim_46__123_next11_125_(arg0)
                elif fn0[0] == 65779:  # {U_Python.Prim.{next12}1}
                ...
                if fn0[0] == 65781:  # {U_Python.Prim.{next2}1}
                  P_c0 = fn0[1]
                  return _idris_Python_46_Prim_46__123_next2_125_(P_c0, arg0)
                elif fn0[0] == 65782:  # {U_Python.Prim.{next3}1}
            ...
            if fn0[0] < 65789:
              if fn0[0] < 65786:
                if fn0[0] == 65784:  # {U_Python.Prim.{next5}1}
                ...
                if fn0[0] == 65786:  # {U_Python.Prim.{next7}1}
                  return _idris_Python_46_Prim_46__123_next7_125_(arg0)
                elif fn0[0] == 65787:  # {U_Python.Prim.{next8}1}
                  P_c0 = fn0[1]
              ...
              if fn0[0] < 65792:
                if fn0[0] == 65789:  # {U_Python.importModule1}
                  P_c0, P_c1 = fn0[1:]
                  return _idris_Python_46_importModule(P_c0, P_c1, arg0)
                elif fn0[0] == 65790:  # {U_Python.{marshalPIO0}1}
                  P_c0 = fn0[1]
                ...
                if fn0[0] == 65792:  # {U_io_return1}
                  P_c0, P_c1, P_c2 = fn0[1:]
                  return _idris_io_95_return(P_c0, P_c1, P_c2, arg0)
                elif fn0[0] == 65793:  # {U_prim__zextInt_BigInt1}
          ...
          if fn0[0] < 65806:
            if fn0[0] < 65800:
              if fn0[0] < 65797:
                if fn0[0] == 65795:  # {U_{Python.Lib.Threading.forkPIO, worker_lam0}1}
                ...
                if fn0[0] == 65797:  # {U_{Python.Prim.iterate, iter_lam0}1}
                  return _idris__123_Python_46_Prim_46_iterate_44__32_iter_95_lam0_125_(arg0)
                elif fn0[0] == 65798:  # {U_{Python.Prim.iterate, iter_lam10}1}
              ...
              if fn0[0] < 65803:
                if fn0[0] == 65800:  # {U_{Python.Prim.iterate, iter_lam12}1}
                  return _idris__123_Python_46_Prim_46_iterate_44__32_iter_95_lam12_125_(arg0)
                elif fn0[0] == 65801:  # {U_{Python.Prim.iterate, iter_lam13}1}
                  P_c0, P_c1, P_c2 = fn0[1:]
                ...
                if fn0[0] == 65803:  # {U_{Python.Prim.iterate, iter_lam2}1}
                  P_c0 = fn0[1]
                  return _idris__123_Python_46_Prim_46_iterate_44__32_iter_95_lam2_125_(P_c0, arg0)
                elif fn0[0] == 65804:  # {U_{Python.Prim.iterate, iter_lam3}1}
            ...
            if fn0[0] < 65812:
              if fn0[0] < 65809:
                if fn0[0] == 65806:  # {U_{Python.Prim.iterate, iter_lam5}1}
                  return _idris__123_Python_46_Prim_46_iterate_44__32_iter_95_lam5_125_(arg0)
                elif fn0[0] == 65807:  # {U_{Python.Prim.iterate, iter_lam6}1}
                  P_c0, P_c1 = fn0[1:]
                ...
                if fn0[0] == 65809:  # {U_{Python.Prim.iterate, iter_lam8}1}
                  return _idris__123_Python_46_Prim_46_iterate_44__32_iter_95_lam8_125_(arg0)
                elif fn0[0] == 65810:  # {U_{Python.Prim.iterate, iter_lam9}1}
                  P_c0 = fn0[1]
              ...
              if fn0[0] < 65815:
                if fn0[0] == 65812:  # {U_{unsafePerformIO0}1}
                  return unsafePerformIO0(arg0)
                elif fn0[0] == 65813:  # {U_Prelude.List.List instance of Prelude.Foldable.Foldable2}
                  P_c0, P_c1, P_c2 = fn0[1:]
                  ...
                  P_c0, P_c1 = fn0[1:]
                  return (65813, P_c0, P_c1, arg0)  # {U_Prelude.List.List instance of Prelude.Foldable.Foldable2}
              else:
                if fn0[0] == 65815:  # {U_Prelude.List.List instance of Prelude.Foldable.Foldable4}
                  P_c0 = fn0[1]
                  return (65814, P_c0, arg0)  # {U_Prelude.List.List instance of Prelude.Foldable.Foldable3}
                else:  # {U_Prelude.List.List instance of Prelude.Foldable.Foldable5}
                  return (65815, arg0)  # {U_Prelude.List.List instance of Prelude.Foldable.Foldable4}
    return _idris_error("unreachable due to case in tail position")
...
def _idris_Prelude_46_Functor_46__123_Prelude_46_IO_39__32_ffi_32_instance_32_of_32_Prelude_46_Functor_46_Functor_44__32_method_32_map_95_lam0_125_(
  ...
  while True:
    return (65792, None, None, APPLY0(e3, in0))  # {U_io_return1}
...
def _idris__123_Python_46_Prim_46_iterate_44__32_iter_95_lam0_125_(in2):
  while True:
    return (65792, None, None, in2)  # {U_io_return1}
...
def _idris_Python_46_Prim_46__123_collect0_125_(in0, in1):
  while True:
    return (65792, None, None, in0.cons(in1))  # {U_io_return1}
...
def _idris__123_Python_46_Lib_46_Threading_46_forkPIO_44__32_worker_95_lam1_125_(
  ...
  while True:
    return _idris_Python_46_Functions_46__36__58_(
      None,
      (1, (0,), (65795,)),  # Python.Telescope.Dep, Python.Telescope.Pi, {U_{Python.Lib.Threading.forkPIO, worker_lam0}1}
...
def _idris__123_Python_46_Prim_46_iterate_44__32_iter_95_lam1_125_(in1):
  while True:
    return (65797,)  # {U_{Python.Prim.iterate, iter_lam0}1}
...
def _idris_Python_46_Prim_46__123_collect1_125_(in0):
  while True:
    return (65771, in0)  # {U_Python.Prim.{collect0}1}
...
def _idris_Python_46_Prim_46__123_foreach1_125_(e2, e3, e4, in0):
  while True:
    return _idris_Prelude_46_Functor_46_Prelude_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
      ...
      None,
      (65761, None),  # {U_Python.IO.unRaw1}
      (65773, e2, e3, e4)  # {U_Python.Prim.{foreach0}1}
    )
...
def _idris_Python_46_Prim_46__123_next1_125_(in1):
  while True:
    return (65776,)  # {U_Python.Prim.{next0}1}

# Prelude.{putStr1}
def _idris_Prelude_46__123_putStr1_125_(in1):
  while True:
    return (65792, None, None, Unit)  # {U_io_return1}
...
def _idris_Python_46_Lib_46_Threading_46__123_forkPIO2_125_(in2):
  while True:
    return (1, (0,), (65763,))  # Python.Telescope.Dep, Python.Telescope.Pi, {U_Python.Lib.Threading.{forkPIO1}1}

# {io_bind2}
def io_bind2(e0, e1, e2, e3, e4, _idris_w):
  while True:
    return (65811, e0, e1, e2, e3, e4, _idris_w)  # {U_{io_bind1}1}
...
def _idris__123_Python_46_Prim_46_iterate_44__32_iter_95_lam3_125_(in5):
  while True:
    return (65803, in5)  # {U_{Python.Prim.iterate, iter_lam2}1}
    ...
    return APPLY0(
      APPLY0(
        ...
        _idris_Python_46_Fields_46__47__58_(
          ...
          _idris_Python_46_Functions_46__36__58_(
            None,
            (1, (0,), (65639,)),  # Python.Telescope.Dep, Python.Telescope.Pi, {U_Main.{case block in main_lam0}1}
...
def _idris_Python_46_Lib_46_Threading_46__123_forkPIO3_125_(in1, in5):
  while True:
    return (65792, None, None, in1)  # {U_io_return1}
...
def _idris_Python_46_Prim_46__123_next3_125_(in5):
  while True:
    return (65781, in5)  # {U_Python.Prim.{next2}1}
...
def _idris__123_Python_46_Prim_46_iterate_44__32_iter_95_lam4_125_(in4):
  while True:
    return (65804,)  # {U_{Python.Prim.iterate, iter_lam3}1}
...
def _idris_Python_46_Lib_46_Threading_46__123_forkPIO4_125_(in1, in4):
  while True:
    return (
      ...
      (65765, in1)  # {U_Python.Lib.Threading.{forkPIO3}1}
    )
...
def _idris_Python_46_Prim_46__123_next4_125_(in4):
  while True:
    return (65782,)  # {U_Python.Prim.{next3}1}
...
def _idris__123_Python_46_Prim_46_iterate_44__32_iter_95_lam5_125_(in3):
  while True:
    return (65805,)  # {U_{Python.Prim.iterate, iter_lam4}1}
...
def _idris_Python_46_Lib_46_Threading_46__123_forkPIO5_125_(e1, in1):
  while True:
    return (
      ...
      _idris_Python_46_Functions_46__36__58_(
        None,
        (1, (0,), (65764,)),  # Python.Telescope.Dep, Python.Telescope.Pi, {U_Python.Lib.Threading.{forkPIO2}1}
        _idris_Python_46_Fields_46__47__58_(
          None,
          None,
      ...
      (65766, in1)  # {U_Python.Lib.Threading.{forkPIO4}1}
    )
...
def _idris_Python_46_Prim_46__123_next9_125_(in5):
  while True:
    return (65787, in5)  # {U_Python.Prim.{next8}1}
...
def _idris__123_Python_46_Prim_46_iterate_44__32_iter_95_lam10_125_(in5):
  while True:
    return (65810, in5)  # {U_{Python.Prim.iterate, iter_lam9}1}
...
def _idris_Main_46__123_main10_125_(in12):
  while True:
    return _idris_Prelude_46_Functor_46_Prelude_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
      ...
      None,
      None,
      _idris_Prelude_46_Foldable_46_concat(None, None, (65710,), (0, (65712,), "")),  # {U_Main.{main7}1}, constructor of Prelude.Algebra.Monoid, {U_Main.{main9}1}
      in12
    )
...
def _idris_Python_46_Prim_46__123_next10_125_(in4):
  while True:
    return (65788,)  # {U_Python.Prim.{next9}1}
...
def _idris__123_Python_46_Prim_46_iterate_44__32_iter_95_lam11_125_(in4):
  while True:
    return (65798,)  # {U_{Python.Prim.iterate, iter_lam10}1}

# Main.{main11}
def _idris_Main_46__123_main11_125_(in10, in21):
  while True:
    return (65792, None, None, (in10 + 1))  # {U_io_return1}

# Python.Prim.{next11}
def _idris_Python_46_Prim_46__123_next11_125_(in3):
  while True:
    return (65777,)  # {U_Python.Prim.{next10}1}
...
def _idris__123_Python_46_Prim_46_iterate_44__32_iter_95_lam12_125_(in3):
  while True:
    return (65799,)  # {U_{Python.Prim.iterate, iter_lam11}1}
  ...
  while True:
    if in0[0] == 1:  # Python.Exceptions.Except
      ...
      if in7[0] == 0:  # Python.Exceptions.StopIteration
        aux1 = (0, (65780,), (65784,))  # constructor of Prelude.Monad.Monad, {U_Python.Prim.{next1}1}, {U_Python.Prim.{next5}1}
        assert aux1[0] == 0  # constructor of Prelude.Monad.Monad
        in9, in10 = aux1[1:]
        aux2 = in9
      ...
      in11 = in0[1]
      aux3 = (0, (65786,), (65778,))  # constructor of Prelude.Monad.Monad, {U_Python.Prim.{next7}1}, {U_Python.Prim.{next11}1}
      ...
      return APPLY0(
        APPLY0(
          _idris_Prelude_46_Monad_46__62__62__61_(
            ...
            None,
            None,
            (0, (65802,), (65806,))  # constructor of Prelude.Monad.Monad, {U_{Python.Prim.iterate, iter_lam1}1}, {U_{Python.Prim.iterate, iter_lam5}1}
          ),
          APPLY0(APPLY0(e9, e8), in7)
        ),
        (65807, e7, e9)  # {U_{Python.Prim.iterate, iter_lam6}1}
      )
    else:  # Prelude.Maybe.Nothing
      aux1 = (0, (65809,), (65800,))  # constructor of Prelude.Monad.Monad, {U_{Python.Prim.iterate, iter_lam8}1}, {U_{Python.Prim.iterate, iter_lam12}1}
      assert aux1[0] == 0  # constructor of Prelude.Monad.Monad
      in9, in10 = aux1[1:]
      aux2 = in9
  ...
  while True:
    return (
      ...
      (
        ...
        (65713, None, None, None, (65644,), (65769, None))  # {U_Prelude.Basics..1}, {U_Main.{main10}1}, {U_Python.Prim.collect1}
      ),
...
def _idris_Main_46__123_main15_125_(in28):
  while True:
    return (65792, None, None, in28)  # {U_io_return1}
...
def _idris_Main_46__123_main17_125_(in31, in32):
  while True:
    return (65791, None, None, None, in31, in32)  # {U_io_bind1}
    ...
    return APPLY0(
      APPLY0(
        ...
        _idris_Python_46_Fields_46__47__58_(
          ...
          _idris_Python_46_Functions_46__36__58_(
            None,
            (1, (0,), (65662,)),  # Python.Telescope.Dep, Python.Telescope.Pi, {U_Main.{main27}1}
  ...
  while True:
    return (
      ...
      _idris_Python_46_Exceptions_46_try(
        ...
        _idris_Python_46_Functions_46__36__58_(
          None,
          (1, (0,), (65685,)),  # Python.Telescope.Dep, Python.Telescope.Pi, {U_Main.{main48}1}
      ...
      _idris_Python_46_Exceptions_46_catch(
        ...
        _idris_Python_46_Exceptions_46_try(
          ...
          (
            ...
            _idris_Python_46_Functions_46__36__58_(
              None,
              (1, (0,), (65681,)),  # Python.Telescope.Dep, Python.Telescope.Pi, {U_Main.{main44}1}
              _idris_Python_46_Fields_46__47__46_(None, None, in46, "mkdir", None),
              (0, "/root/hello", Unit)  # Builtins.MkSigma
            ),
...
def _idris_Main_46__123_main53_125_(in45):
  while True:
    return (65791, None, None, None, _idris_Python_46_Lib_46_Os_46_import_95_(), (65690,))  # {U_io_bind1}, {U_Main.{main52}1}

# Main.{main54}
def _idris_Main_46__123_main54_125_(in44):
  while True:
    return (65791, None, None, None, _idris_Prelude_46_putStr(None, "\n"), (65691,))  # {U_io_bind1}, {U_Main.{main53}1}
...
def _idris_Main_46__123_main63_125_(in8, in1, in9):
  while True:
    return (
      ...
      None,
      None,
      _idris_Python_46_Prim_46_iterate(None, None, in8, 0, (65648,)),  # {U_Main.{main14}1}
  ...
  while True:
    return (
      ...
      _idris_Python_46_Fields_46__62__58_(
        ...
        _idris_Python_46_Functions_46__36__58_(
          None,
          (1, (0,), (65665,)),  # Python.Telescope.Dep, Python.Telescope.Pi, {U_Main.{main2}1}
...
def _idris_Main_46__123_main66_125_(in3, in1, in4):
  while True:
    return (
      ...
      _idris_Python_46_Functions_46__36__58_(
        None,
        (1, (0,), (65654,)),  # Python.Telescope.Dep, Python.Telescope.Pi, {U_Main.{main1}1}
  ...
  while True:
    return (
      ...
      _idris_Python_46_Fields_46__47__58_(
        ...
        _idris_Python_46_Functions_46__36__58_(
          None,
          (1, (0,), (65643,)),  # Python.Telescope.Dep, Python.Telescope.Pi, {U_Main.{main0}1}
          _idris_Python_46_Fields_46__47__46_(None, None, in1, "get", None),
          (0, "http://idris-lang.org", Unit)  # Builtins.MkSigma
        ),
        "text",
...
def _idris_Python_46_Lib_46_Threading_46_forkPIO_58_worker_58_0(e0, e1, e2):
  while True:
    return (65791, None, None, None, e1, (65796, e2))  # {U_io_bind1}, {U_{Python.Lib.Threading.forkPIO, worker_lam1}1}
...
def _idris_Python_46_Prim_46_iterate_58_iter_58_0(
  ...
  while True:
    return (
      ...
      (65801, e9, e8, e7)  # {U_{Python.Prim.iterate, iter_lam13}1}
    )
  ...
  while True:
    if e4:  # Prelude.List.::
      ...
      return APPLY0(
        ...
        APPLY0(
          APPLY0(
            APPLY0(_idris_Prelude_46_Foldable_46_foldr(None, None, None, (65816,)), e2),  # {U_Prelude.List.List instance of Prelude.Foldable.Foldable5}
            e3
          ),
          in1
        )
...
def _idris_Prelude_46_Functor_46_Prelude_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
  ...
  while True:
    return (65791, None, None, None, e4, (65714, e3))  # {U_io_bind1}, {U_Prelude.Functor.{Prelude.IO' ffi instance of Prelude.Functor.Functor, method map_lam0}1}
  ...
  while True:
    if e11 is not None:  # Prelude.Maybe.Just
      ...
      return APPLY0(
        ...
        (65770, e6, e9)  # {U_Python.Prim.{case block in Python.Prim.iterate, iter_lam0}1}
      )
    else:  # Prelude.Maybe.Nothing
