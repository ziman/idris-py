...
def idris_Python_46__36__46_(e0, e1, e2, e3, e4):
  while True:
    return idris_Prelude_46_Functor_46_Prelude_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
      ...
      (65766, e3, e2, e4)  # {U_Python.{$.0}1}
    )

# Python.$:
def idris_Python_46__36__58_(e0, e1, e2, e3, e4):
  while True:
    return (65771, None, None, None, e3, (65767, e2, e4))  # {U_io_bind1}, {U_Python.{$:0}1}
...
def idris_Python_46_Prim_46_collect(e0, e1):
  while True:
    return idris_Prelude_46_Functor_46_Prelude_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
      ...
      idris_Python_46_Prim_46_foreach(None, None, e1, ConsList(), (65747,))  # {U_Python.Prim.{collect1}1}
    )
  ...
  while True:
    return (
      ...
      idris_Python_46__36__58_(
        None,
        None,
        (1, (1,), (65737,)),  # Python.Telescope.Bind, Python.Telescope.Forall, {U_Python.Lib.Threading.{forkPIO1}1}
        ...
        (0, e0, (0, 1, (0,)))  # Python.Telescope.Cons, Python.Telescope.Cons, Python.Telescope.Nil
      ),
...
def idris_Python_46_marshalPIO(e0, e1):
  while True:
    return idris_unsafePerformIO(None, None, (65770, e1))  # {U_Python.{marshalPIO0}1}
...
def idris_Python_46_Exceptions_46_showException(e0):
  while True:
    return idris_unsafePerformIO(None, None, (65730, e0))  # {U_Python.Exceptions.{showException0}1}
...
def idris_Python_46_Lib_46_Threading_46__123_forkPIO1_125_(in0):
  while True:
    return (1, (0,), (65736,))  # Python.Telescope.Bind, Python.Telescope.Pi, {U_Python.Lib.Threading.{forkPIO0}1}
...
def io_bind2(e0, e1, e2, e3, e4, idris_w):
  while True:
    return (65791, e0, e1, e2, e3, e4, idris_w)  # {U_{io_bind1}1}
...
def idris_Main_46__123_main10_125_(in12):
  while True:
    return idris_Prelude_46_Functor_46_Prelude_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
      ...
      None,
      None,
      idris_Prelude_46_Foldable_46_concat(None, None, (65711,), (0, (65713,), "")),  # {U_Main.{main7}1}, constructor of Prelude.Algebra.Monoid, {U_Main.{main9}1}
      in12
    )
...
def idris_Main_46__123_main53_125_(in45):
  while True:
    return (65771, None, None, None, idris_Python_46_Lib_46_Os_46_import_95_(), (65691,))  # {U_io_bind1}, {U_Main.{main52}1}

# Main.{main54}
def idris_Main_46__123_main54_125_(in44):
  while True:
    return (65771, None, None, None, idris_Prelude_46_putStr(None, "\n"), (65692,))  # {U_io_bind1}, {U_Main.{main53}1}
...
def idris_Main_46__123_main59_125_(in25, in39):
  while True:
    return (
      ...
      None,
      None,
      idris_Python_46_Lib_46_Threading_46_forkPIO((-1,), APPLY0(in25, "B")),  # Prelude.Nat.Nat
...
def idris_Main_46__123_main60_125_(in1, in24):
  while True:
    ...
    return (
      ...
      None,
      None,
      idris_Python_46_Lib_46_Threading_46_forkPIO((-1,), APPLY0(in25, "A")),  # Prelude.Nat.Nat
...
def idris_Main_46__123_main63_125_(in8, in1, in9):
  while True:
    return (
      ...
      None,
      None,
      idris_Python_46_Prim_46_iterate(None, None, in8, 0, (65649,)),  # {U_Main.{main14}1}
  ...
  while True:
    if e4:  # Prelude.List.::
      ...
      aux1 = APPLY0(
        ...
        APPLY0(
          APPLY0(
            APPLY0(idris_Prelude_46_Foldable_46_foldr(None, None, None, (65796,)), e2),  # {U_Prelude.List.List instance of Prelude.Foldable.Foldable5}
            e3
          ),
          in1
        )
